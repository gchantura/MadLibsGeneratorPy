...
Label(root, text='Click Any One: ', font='arial 15 bold').place(x=50, y=80)
...
def madlib2():
    ...
    print(
        'Last night I dreamed I was a ' + adjactive + ' butterfly with ' + color + ' splocthes that looked like ' +
        thing + ' .I flew to ' + place + ' with my bestfriend and ' + person + ' who was a ' + adjactive1 + ' ' +
...
def madlib3():
    ...
    print(
        'Today we picked apple from ' + person + "'s Orchard. I had no idea there were so many different varieties of apples. I ate " +
